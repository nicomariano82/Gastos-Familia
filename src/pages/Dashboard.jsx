...
export default function Dashboard() {
  ...
  return (
    <div style={styles.page}>
        ...
        <div style={styles.headerTop}>
          ...
          <div style={styles.headerActions}>
            <button
              ...
              onClick={() => exportarCSV(gastos, nombreMes)}
              title="Exportar CSV"
            >📊</button>
            <button style={styles.logoutBtn} onClick={signOut} title="Cerrar sesión">🚪</button>
          </div>
        </div>
        ...
        <div style={styles.usuarioRow}>
          {Object.entries(porUsuario).map(([nombre, info]) => (
            <div key={nombre} style={styles.usuarioChip}>
              <span style={{ ...styles.usuarioAvatar, background: info.color }}>
      ...
      {/* FAB */}
      <button style={styles.fab} onClick={() => setMostrarModal(true)}>
        +
      </button>
...
const styles = {
  ...
  exportBtn: { background: 'rgba(255,255,255,0.2)', border: 'none', borderRadius: '10px', padding: '8px 12px', fontSize: '18px', cursor: 'pointer' },
  logoutBtn: { background: 'rgba(255,255,255,0.2)', border: 'none', borderRadius: '10px', padding: '8px 12px', fontSize: '18px', cursor: 'pointer' },
  heroCard: {
